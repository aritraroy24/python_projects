...
image_path = os.path.join(current_path, 'sprites') # The image folder path
...
GAME_SPRITES = {}
GAME_SOUNDS = {}
PLAYER = 'gallery/image/bird.png'
BACKGROUND = 'gallery/image/background.png'
PIPE = 'gallery/image/pipe.png'
...
def mainGame():
    ...
    while True:
        ...
        for digit in myDigits:
            SCREEN.blit(GAME_SPRITES['numbers'][digit], (Xoffset, SCREENHEIGHT*0.9))
            Xoffset += GAME_SPRITES['numbers'][digit].get_width()
        pygame.display.update()
        FPSCLOCK.tick(FPS)

def isCollide(playerx, playery, upperPipes, lowerPipes):
    if playery> GROUNDY - 33  or playery<0:
...
if __name__ == "__main__":
    ...
    GAME_SPRITES['message'] =pygame.image.load('gallery/image/message.png').convert_alpha()
    GAME_SPRITES['base'] =pygame.image.load('gallery/image/base.png').convert_alpha()
